              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                    ...
                    labelStyle: TextStyle(
                        color:
                            provider.isDark() ? Colors.white54 : Colors.grey)),
              ),
            ),
            SizedBox(
              height: 12,
  ...
  void addTask() {
    if (formKey.currentState?.validate() == true) {
      ...
      MyDatabase.insertTask(task).then((value) {
        ...
        showMassege(context, 'Task Added Successfully', posActionName: 'Ok',
            posAction: () {
        ...
        showMassege(context, 'Task saved locally', posActionName: 'Ok',
            posAction: () {
          Navigator.pop(context);
        });
      });
